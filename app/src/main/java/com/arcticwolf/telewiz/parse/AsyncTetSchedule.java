...
public class AsyncTetSchedule extends AsyncTask<Void,Void,ArrayList<ShowInfo>> {

    private FragmentSchedules context;
    private String link;
    private ArrayList<ShowInfo> arrayShow = new ArrayList<>();

    public AsyncTetSchedule(FragmentSchedules context, String link){
    ...
    protected ArrayList<ShowInfo> doInBackground(Void... params) {
        ...
        String desc = "";
        String imglink = "";
        String channelLink = "http://tet.tv/uk";
        String channelTitle = "TET";
        String selectorTime = "a > span.time";
        String selectorName = "a > strong.title";
        String selectorUrlShow = "ul.schedule-scroll.schedule-day-scroll > li > a";
